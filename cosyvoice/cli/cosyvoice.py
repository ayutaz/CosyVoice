...
class CosyVoice:
    ...
    def __init__(self, model_dir, load_jit=False, load_trt=False, fp16=False, use_compile=False, trt_concurrent=1):
...
class CosyVoice2(CosyVoice):
    ...
    def __init__(self, model_dir, load_jit=False, load_trt=False, load_vllm=False, fp16=False, use_compile=False, trt_concurrent=1):
        self.instruct = True if '-Instruct' in model_dir else False
        self.model_dir = model_dir
        self.fp16 = fp16
        if not os.path.exists(model_dir):
